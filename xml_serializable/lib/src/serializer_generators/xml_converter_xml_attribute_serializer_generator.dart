...
class XmlConverterXmlAttributeSerializerGenerator extends SerializerGenerator {
  ...
  const XmlConverterXmlAttributeSerializerGenerator(
    this._converter, {
...
class NullableXmlConverterXmlAttributeSerializerGenerator
    extends XmlConverterXmlAttributeSerializerGenerator {
  const NullableXmlConverterXmlAttributeSerializerGenerator(
    String converter,
  ) : super(
          converter,
          isNullable: true,
